...
{
    public partial class BDReportesContext : DbContext
    {
        public BDReportesContext()
        {
        }
        ...
        public virtual DbSet<Dium> Dia { get; set; } = null!;
        public virtual DbSet<EnfermedadesIntervencionesPersona> EnfermedadesIntervencionesPersonas { get; set; } = null!;
        public virtual DbSet<ExpedienteVacunacion> ExpedienteVacunacions { get; set; } = null!;
        public virtual DbSet<Factura> Facturas { get; set; } = null!;
        public virtual DbSet<FichaMedica> FichaMedicas { get; set; } = null!;
        public virtual DbSet<GrupoSanguineo> GrupoSanguineos { get; set; } = null!;
        public virtual DbSet<Hora> Horas { get; set; } = null!;
        public virtual DbSet<HoraDiaActividadPersona> HoraDiaActividadPersonas { get; set; } = null!;
        public virtual DbSet<MarcaVacuna> MarcaVacunas { get; set; } = null!;
        public virtual DbSet<MedicamentoConsumoPersona> MedicamentoConsumoPersonas { get; set; } = null!;
        public virtual DbSet<MedicoTelefonoPersona> MedicoTelefonoPersonas { get; set; } = null!;
        public virtual DbSet<ObservacionesPersona> ObservacionesPersonas { get; set; } = null!;
        public virtual DbSet<Persona> Personas { get; set; } = null!;
        public virtual DbSet<Producto> Productos { get; set; } = null!;
        public virtual DbSet<Sexo> Sexos { get; set; } = null!;
        public virtual DbSet<SistemaSalud> SistemaSaluds { get; set; } = null!;
        public virtual DbSet<TipoAlergium> TipoAlergia { get; set; } = null!;
        public virtual DbSet<TipoDocumentoIdentificacion> TipoDocumentoIdentificacions { get; set; } = null!;
        public virtual DbSet<TratamientoMedicoPersona> TratamientoMedicoPersonas { get; set; } = null!;
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
                optionsBuilder.UseSqlServer("Server=localhost;Database=BDReportes;User=sa;Password=Samupi7185467*;");
            }
        }
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            {
                entity.HasKey(e => e.Iiddetallefactura)
                    .HasName("PK_DetalleFacturas");
            ...
            {
                entity.HasKey(e => e.Iidenfermedadesintervenciones)
                    .HasName("PK_EnfermedadesIntervenciones");
                ...
                entity.HasOne(d => d.IidpersonaNavigation)
                    .WithMany(p => p.EnfermedadesIntervencionesPersonas)
            ...
            modelBuilder.Entity<ExpedienteVacunacion>(entity =>
            {
                ...
                entity.HasOne(d => d.IidmarcavacunaNavigation)
                    .WithMany(p => p.ExpedienteVacunacions)
            ...
            modelBuilder.Entity<Factura>(entity =>
            {
                ...
                entity.HasOne(d => d.IidcompaniaNavigation)
            ...
            modelBuilder.Entity<FichaMedica>(entity =>
            {
                ...
                entity.HasOne(d => d.IidgruposanguineoNavigation)
                    .WithMany(p => p.FichaMedicas)
                ...
                entity.HasOne(d => d.IidsistemasaludNavigation)
                    .WithMany(p => p.FichaMedicas)
                    .HasForeignKey(d => d.Iidsistemasalud)
                    .HasConstraintName("FK_FichaMedica_SistemaSalud");

                entity.HasOne(d => d.IidtipoalergiaNavigation)
                    .WithMany(p => p.FichaMedicas)
            ...
            modelBuilder.Entity<HoraDiaActividadPersona>(entity =>
            {
                ...
                entity.HasOne(d => d.IiddiaNavigation)
                    .WithMany(p => p.HoraDiaActividadPersonas)
                    .HasForeignKey(d => d.Iiddia)
                    .HasConstraintName("FK_HoraDiaActividadPersona_Dia");

                entity.HasOne(d => d.IidhoraNavigation)
                    .WithMany(p => p.HoraDiaActividadPersonas)
            ...
            modelBuilder.Entity<MedicamentoConsumoPersona>(entity =>
            {
                ...
                entity.HasOne(d => d.IidpersonaNavigation)
                    .WithMany(p => p.MedicamentoConsumoPersonas)
                    .HasForeignKey(d => d.Iidpersona)
            ...
            modelBuilder.Entity<MedicoTelefonoPersona>(entity =>
            {
                ...
                entity.HasOne(d => d.IidpersonaNavigation)
                    .WithMany(p => p.MedicoTelefonoPersonas)
                    .HasForeignKey(d => d.Iidpersona)
            ...
            modelBuilder.Entity<ObservacionesPersona>(entity =>
            {
                ...
                entity.HasOne(d => d.IidpersonaNavigation)
                    .WithMany(p => p.ObservacionesPersonas)
                    .HasForeignKey(d => d.Iidpersona)
            ...
            modelBuilder.Entity<TratamientoMedicoPersona>(entity =>
            {
                ...
                entity.HasOne(d => d.IidpersonaNavigation)
                    .WithMany(p => p.TratamientoMedicoPersonas)
                    .HasForeignKey(d => d.Iidpersona)
